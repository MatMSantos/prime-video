...
import '/widgets/container-landing/container-landing.scss'
...
export const LandingContainer = () => {
  return (
    <section className="container-landing">
      <h2 className="subtitle">{i18n('containers.landing.text.subtitle')}</h2>
      <p className="primary">{i18n('containers.landing.text.primary')}</p>
      <p className="secondary">{i18n('containers.landing.text.secondary')}</p>
      <ButtonLink
        to={SIGNIN_URL}
        textLabel={i18n('containers.landing.buttonLink.label.signIn')}
      />
      ...
      <ButtonLink
        to={TRIAL_URL}
        textLabel={i18n('containers.landing.buttonLink.label.trial')}
      />
    </section>
  )
} 
