...
// const text1 = i18n('name.meta.containers.landing.buttonLink.label.signIn')
const text2 = i18n('name.meta.containers.landing.buttonLink.label.trial')
...
export const LandingContainer = () => {
  return (
    <section className="container-landing">
      <h2 className="subtitle">{i18n('name.meta.containers.landing.text.subtitle')}</h2>
      <p className="primary">{i18n('name.meta.containers.landing.text.primary')}</p>
      <p className="secondary">{i18n('name.meta.containers.landing.text.secondary')}</p>
      <ButtonLink
        to={SIGNIN_URL}
        textLabel={i18n('name.meta.containers.landing.buttonLink.label.signIn')}
      />
      ...
      <ButtonLink
        to={TRIAL_URL}
        textLabel={i18n('name.meta.containers.landing.buttonLink.label.trial')}
      />
    </section>
  )
} 
