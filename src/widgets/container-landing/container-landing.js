  ...
  return (
    <section className="container-landing">
      <h2 className="subtitle">
        {i18n("meta.home.containers.landing.text.subtitle")}
      </h2>
      <p className="primary">
